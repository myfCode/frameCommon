...
*/
/* lewis.wen 20170531 需要依赖global.js */
;(function () {
    ...
    var startHandler = function (e, obj) {
        ...
        moveHandler = function (e, obj) {
            ...
            if (patternAry.length > 0) {
                ...
                iObj.line.css({
                    'width': (laMove.length + linewidth) + 'px',
            ...
            if (idx) {
                ...
                if (patternAry.indexOf(pattId) == -1) {
                    ...
                    //to create new line
                    var line = $('<div class="patt-lines" style="top:' + (newY - (linewidth/2)) + 'px; left:' + (newX - (linewidth/2)) + 'px"></div>');
                    iObj.line = line;
                    iObj.lineX1 = newX;
                    iObj.lineY1 = newY;
                    //add on dom
    ...
    function PatternLock(selector, option) {
        ...
        iObj.option.onEach = option.onEach || nullFunc;
